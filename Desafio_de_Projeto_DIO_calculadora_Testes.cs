using System;
using Xunit;
using Desafio_de_Projeto_DIO_calculadora_Testes;

namespace Desafio_de_Projeto_DIO_calculadora_Testes;
{
    public class UnitTest1
    {
        ...
        // Teste Soma com vários resultados
        [Theory]
        [InlineData (1,2,3)]
        [InlineData (4,5,9)]
        [InlineData (3,2,5)]
        ...
        // Teste Subtrair com vários resultados
        [Theory]
        [InlineData(3, 2, 1)]
        [InlineData(7, 2, 5)]
        [InlineData(8, 1, 7)]
        ...
        // Teste Multiplicar com vários resultados
        [Theory]
        [InlineData(3, 2, 6)]
        [InlineData(5, 2, 10)]
        [InlineData(8, 2, 16)]
        ...
        // Teste Dividir com vários resultados
        [Theory]
        [InlineData(6, 2, 3)]
        [InlineData(10, 2, 5)]
        [InlineData(9, 3, 3)]
